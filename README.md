...
> **데이터 수집부터 AI 실시간 관제까지, 서울시민의 호흡기 건강을 위한 통합 솔루션**

---

### 🚀 Developer: [박영훈]
데이터 수집부터 AI 모델 서빙, DB 연동까지 **Full-Cycle 개발**에 몰입하는 개발자입니다.  
복잡한 공공 데이터와 실시간 영상 분석을 서비스화하며, 성능 최적화와 안정적인 데이터 파이프라인 구축에 강점이 있습니다.
